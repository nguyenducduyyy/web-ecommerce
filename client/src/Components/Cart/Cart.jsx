...
const columns = [
  ...
  },
  {
    ...
    align: "center",
    render: (price) => (
      <span style={{ whiteSpace: "nowrap" }}>{price.toLocaleString()} đ</span>
    ),
  },
  {
    title: "Giá ",
...
const Cart = () => {
  ...
  const handlePlaceOrder = async () => {
    try {
      if (!paymentOption) {
        message.error(
          "Vui lòng chọn phương thức thanh toán trước khi đặt đơn hàng."
        );
      ...
      if (!selectedAddress) {
        message.error(
          "Vui lòng chọn địa chỉ giao hàng trước khi đặt đơn hàng."
        );
                  ...
                  <Card>
                    ...
                    <div>
                      <Radio
                        ...
                        onChange={() => handlePaymentOptionChange("vnpay")}
                      >
